...
Next, edge strength is defined as $\sqrt{\lambda_{\max}}$, and indicates the dominant gradient magnitude scale of the patch~\cite{khan_corner_detection,opencv_gst}. The example patches below show three ways the same 90-degree white line can produce lower edge-strength values: reduced contrast, increased blur, and movement away from the center-weighted detector support.
